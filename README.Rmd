...
> TimeCycle is designed to detect rhythmic genes in circadian transcriptomic time-series data. Based on [topological data analysis](articles/TimeCycle.html#takens-theorem-1), TimeCycle provides a reliable and efficent reference-free framework for cycle detection --- handling custom sampling schemes, replicates, and missing data.

-   To learn more about the [theory](articles/TimeCycle.html#theory-1) and [usage](articles/TimeCycle.html#usage-1) of TimeCycle, see `vignette("TimeCycle")`.
